...
/**
 * This is the item provider adapter for a {@link jsongrammar.DetailedGrammar} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DetailedGrammarItemProvider 
	...
	protected void addCurlyBracesReferencesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DetailedGrammar_curlyBracesReferences_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DetailedGrammar_curlyBracesReferences_feature", "_UI_DetailedGrammar_type"),
				 JsongrammarPackage.Literals.DETAILED_GRAMMAR__CURLY_BRACES_REFERENCES,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_DetailedGrammar_bracketsReferences_feature", "_UI_DetailedGrammar_type"),
				 JsongrammarPackage.Literals.DETAILED_GRAMMAR__BRACKETS_REFERENCES,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addKeyValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DetailedGrammar_keyValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DetailedGrammar_keyValue_feature", "_UI_DetailedGrammar_type"),
				 JsongrammarPackage.Literals.DETAILED_GRAMMAR__KEY_VALUE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_DetailedGrammar_curlyBracesEClass_feature", "_UI_DetailedGrammar_type"),
				 JsongrammarPackage.Literals.DETAILED_GRAMMAR__CURLY_BRACES_ECLASS,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_DetailedGrammar_bracketsEClass_feature", "_UI_DetailedGrammar_type"),
				 JsongrammarPackage.Literals.DETAILED_GRAMMAR__BRACKETS_ECLASS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(JsongrammarPackage.Literals.DETAILED_GRAMMAR__ROOT_ECLASS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DetailedGrammar.class)) {
