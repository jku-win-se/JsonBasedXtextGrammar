...
public class WizardOclCreationPage extends WizardPage{

	private IFile oclFile;
	...
	public WizardOclCreationPage(String pageName, IStructuredSelection selection, IJdtHelper jdtHelper) {
		super(pageName);
	...
	public void createControl(Composite parent) {
		...
		importedEPackagesViewer.setContentProvider(new IStructuredContentProvider() {
			...
			public Object[] getElements(Object inputElement) {
				return Iterables.toArray(Arrays.asList(oclFile), IFile.class);
			}
		});
		...
		addButton.setText("Add OCL File");
...
//		setPageComplete(false); // added by Alessandro
	...
	private void updateUI() {
		importedEPackagesViewer.setInput(this.oclFile);
		importedEPackagesViewer.refresh();
		validatePage();
	}
	
	private void validatePage() {
		setPageComplete(this.oclFile != null);
	}
	
	
	public IFile getOclFile() {
		return oclFile;
	}
