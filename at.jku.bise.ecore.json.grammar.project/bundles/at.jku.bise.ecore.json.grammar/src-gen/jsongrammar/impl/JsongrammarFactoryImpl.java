...
public class JsongrammarFactoryImpl extends EFactoryImpl implements JsongrammarFactory {
	...
	public static JsongrammarFactory init() {
		try {
			JsongrammarFactory theJsongrammarFactory = (JsongrammarFactory)EPackage.Registry.INSTANCE.getEFactory(JsongrammarPackage.eNS_URI);
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case JsongrammarPackage.DETAILED_GRAMMAR: return createDetailedGrammar();
			case JsongrammarPackage.JSON_GRAMMAR: return createJsonGrammar();
			default:
